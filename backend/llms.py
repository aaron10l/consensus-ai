...
async def get_llama_response(message_history):
    ...
    try:
        ...
        response = await loop.run_in_executor(None, lambda: client.invoke_model(modelId=model_id, body=request))
...
async def get_claude_response(message_history):
